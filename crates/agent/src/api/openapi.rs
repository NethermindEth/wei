...
use crate::api::handlers::AnalyzeResponse;
use crate::models::analysis::{Analysis, AnalysisResult, ProposalAnalysis, ProposalMetadata};
...
#[openapi(
    ...
    components(
        schemas(Proposal, AnalyzeResponse, Analysis, AnalysisResult, ProposalAnalysis, ProposalMetadata)
    ),
    tags(
